      ...
      <div className="">
        ...
        <div className="max-w-[1100px] mx-auto my-16 space-y-10">
          ...
          <div>
            <div>
              ...
              <p className="text-gray-600 md:text-lg">
                Expolre top living options with us
              </p>
            </div>
            <HousingPick />
          </div>
          ...
          <div className="flex flex-col justify-between gap-8 md:flex-row">
            {threeData.map((item) => (
              <div
                className="mx-auto transition-all duration-300 border-2 rounded-xl w-80 hover:shadow-xl hover:cursor-pointer"
                key={item._id}
              >
                <Card
                  image={item.image}
          ...
          <div className="flex flex-col items-center justify-center gap-2 py-7">
            <h1 className="text-xl font-bold md:text-3xls">
